...
Oryginalny kod Eidosa jest objęty licencją GPL-3.0-or-later. Dołączone tłumaczenia kodu OMOD są objęte licencją GPL-3.0-only; zobacz [informacje o pierwotnych autorach](../../../crates/eidos-install/src/install/omod/known_handlers/UPSTREAM.md). Program pomocniczy NIF zachowuje [licencje i informacje o autorach swoich składników](../../../native/eidos-nif-preview/UPSTREAM.md). Zarządzanie modami należy do wszystkich.
