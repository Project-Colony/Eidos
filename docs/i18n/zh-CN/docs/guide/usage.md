...
劲时该怎么办,见 [troubleshooting.zh-CN.md](troubleshooting.md)。
...
列出你自己的附加组件;见 [extensions.zh-CN.md](extensions.md)。
...
一个扩展是它运行的一个程序。见 [extensions.zh-CN.md](extensions.md)。
