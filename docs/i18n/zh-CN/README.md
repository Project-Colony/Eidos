...
**Nexus。** 连接账号后，可以接收“Mod Manager Download”链接、检查更新，以及查看作者及其个人资料。合集会按照配方安装，支持中断后继续，并明确报告不支持的步骤。匹配时会核对确切的来源文件；不完整的旧元数据仍标记为未验证。下载选项卡可以筛选、排序、隐藏和删除压缩包。**离线**开关会停止访问 Nexus。
