...
**Nexus。** 連接帳號後，可以接收「Mod Manager Download」連結、檢查更新，以及查看作者及其個人資料。合集會按照配方安裝，支援中斷後繼續，並明確回報不支援的步驟。比對時會核對確切的來源檔案；不完整的舊中繼資料仍標示為未驗證。下載分頁可以篩選、排序、隱藏和刪除壓縮檔。**離線**開關會停止存取 Nexus。
