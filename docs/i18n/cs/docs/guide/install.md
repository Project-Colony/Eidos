...
viz [usage.cs.md](usage.md). Kompletní prohlídka je tamtéž.
...
[troubleshooting.cs.md](troubleshooting.md).

## Už je něco špatně?

[troubleshooting.cs.md](troubleshooting.md) pokrývá přepínače prostředí,
