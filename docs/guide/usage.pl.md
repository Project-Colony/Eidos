...
opisuje [troubleshooting.pl.md](troubleshooting.pl.md).
...
[troubleshooting.pl.md](troubleshooting.pl.md#dlaczego-passthrough-jest-domyślnie-wyłączony).
...
twoje własne dodatki; zob. [extensions.pl.md](extensions.pl.md).
...
program, który on uruchamia. Zob. [extensions.pl.md](extensions.pl.md).
