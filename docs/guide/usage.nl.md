...
staat in [troubleshooting.nl.md](troubleshooting.nl.md).
...
[troubleshooting.nl.md](troubleshooting.nl.md#waarom-passthrough-standaard-uit-staat).
...
toont je eigen add-ons; zie [extensions.nl.md](extensions.nl.md).
...
map, staan in [tools.nl.md](tools.nl.md).
...
[extensions.nl.md](extensions.nl.md).
