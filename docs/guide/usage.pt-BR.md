...
parece errado, veja [troubleshooting.pt-BR.md](troubleshooting.pt-BR.md).
...
[troubleshooting.pt-BR.md](troubleshooting.pt-BR.md#por-que-o-passthrough-vem-desligado).
...
próprios add-ons; veja [extensions.pt-BR.md](extensions.pt-BR.md).
...
estão em [tools.pt-BR.md](tools.pt-BR.md).
...
um programa que ele roda. Veja [extensions.pt-BR.md](extensions.pt-BR.md).
