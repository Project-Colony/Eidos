...
[usage.ko.md](usage.ko.md) 참고. 전체 안내도 거기에 있습니다.
...
[troubleshooting.ko.md](troubleshooting.ko.md)에 있습니다.

## 벌써 뭔가 잘못됐나요?

[troubleshooting.ko.md](troubleshooting.ko.md)가 환경 스위치, 연산 카운터 읽는
