...
najdete v [troubleshooting.cs.md](troubleshooting.cs.md).
...
vysvětluje [troubleshooting.cs.md](troubleshooting.cs.md#proč-je-passthrough-ve-výchozím-stavu-vypnutý).
...
vlastní doplňky; viz [extensions.cs.md](extensions.cs.md).
...
který spustí. Viz [extensions.cs.md](extensions.cs.md).
