...
bkz. [troubleshooting.tr.md](troubleshooting.tr.md).
...
kapalı geldiği - [troubleshooting.tr.md](troubleshooting.tr.md#passthrough-neden-öntanımlı-olarak-kapalı)
içinde anlatılıyor.
...
eklentilerinizi listeler; bkz. [extensions.tr.md](extensions.tr.md).
...
klasöründen değil birleşik yoldan başlatıldığı [tools.tr.md](tools.tr.md) içinde.
...
çalıştırdığı bir programdır. Bkz. [extensions.tr.md](extensions.tr.md).
