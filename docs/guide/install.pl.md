...
przenośnej - zob. [usage.pl.md](usage.pl.md). Pełna wycieczka jest tamże.
...
[troubleshooting.pl.md](troubleshooting.pl.md).

## Coś już nie działa?

[troubleshooting.pl.md](troubleshooting.pl.md) opisuje przełączniki
