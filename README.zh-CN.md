...
[usage.zh-CN.md](docs/guide/usage.zh-CN.md#实例全局与便携)。
...
**[docs/guide/install.zh-CN.md](docs/guide/install.zh-CN.md)**。
...
| 你想要... | 放在前面 |
|---|---|
| 配合 Community Shaders 的 DLSS | `PROTON_ENABLE_NVAPI=1` - 没有它,DLSS 会悄无声息地永远初始化不了;完整清单见 [guide/graphics.zh-CN.md](docs/guide/graphics.zh-CN.md) |
...
[guide/troubleshooting.zh-CN.md](docs/guide/troubleshooting.zh-CN.md)。

## 接下来去哪

| 如果你想... | |
|---|---|
| 安装它 | [guide/install.zh-CN.md](docs/guide/install.zh-CN.md) |
| 学会命令行和图形界面 | [guide/usage.zh-CN.md](docs/guide/usage.zh-CN.md) |
| 配置 xEdit、BodySlide 或 DynDOLOD | [guide/tools.zh-CN.md](docs/guide/tools.zh-CN.md) |
| 玩 Fallout 4(F4SE、版本、NVIDIA 碎片崩溃) | [guide/fallout4.zh-CN.md](docs/guide/fallout4.zh-CN.md) |
| 让 DLSS / 帧生成跑起来(Community Shaders) | [guide/graphics.zh-CN.md](docs/guide/graphics.zh-CN.md) |
| 修好看起来不对劲的东西 | [guide/troubleshooting.zh-CN.md](docs/guide/troubleshooting.zh-CN.md) |
| 知道它为什么快,并自己验证 | [internals/performance.md](docs/internals/performance.md) |
| 理解它内部怎么工作 | [internals/architecture.md](docs/internals/architecture.md) |
| 构建它、测试它、参与贡献 | [internals/contributing.md](docs/internals/contributing.md) |
| 知道它究竟为何存在 | [project/landscape.md](docs/project/landscape.md) |

完整索引在 [docs/README.zh-CN.md](docs/README.zh-CN.md);安全策略以及如何报告漏洞
...
[`docs/internals/contributing.md`](docs/internals/contributing.md) 里有步骤。

## 支持的游戏

**Skyrim SE/AE** - 已在真实游玩中验证。**Fallout 4** 也已经端到端接好(自动换用 F4SE、
archive invalidation、星号加载顺序、LOOT、`.fos` 存档) - 见
[guide/fallout4.zh-CN.md](docs/guide/fallout4.zh-CN.md)。按共享的游戏描述符接好线、
